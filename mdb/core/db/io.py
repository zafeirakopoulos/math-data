...
class MDB:
	...
	def add_instance(self, mdb: DB, data):
		...
		try:
			...
			mutex.release()
		return response
	def remove_instance(self, mdb, data):
		"""
	...
	def retrieve_instance(self, mdb, data):
		...
		return instance
	def update_instance(self, mdb, data):
		"""
	...
	def find(self, mdb, data):
		...
		# Return SHA keys
		return []
	def search(self, mdb,  text):
		"""Return the instances matching text.
		"""
	def filter(self, mdb,  criteria):
