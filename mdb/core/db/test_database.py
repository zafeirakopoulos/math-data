...
def test_add_instance(data, io_x):
    ...
    response = io_x.add_instance(data, r)
    print(response)
    return response
...
def test_remove_instance(sha):
    ...
    response = io_x.remove_instance(data, r)
    print(response)
    return response
...
def test_update_instance(sha):
    ...
    response = io_x.update_instance(data, r)
    print(response)
...
def test_retrieve_instance(sha):
    ...
    response = io_x.retrieve_instance(data, r)
    print(response)
    return response
